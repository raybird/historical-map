...
// agent 風格：非互動產生器
run('npx ng generate @kevin/historical-map-schematics:add-period --id=ming --label=明朝 ' +
    '--start-year=1368 --end-year=1644 --color=#C8102E --description=明朝 --interactive=false');
run('npx ng generate @kevin/historical-map-schematics:add-event --id=ming-001 --title=靖難之役 ' +
